...
class VoiceControllerMPS:
    ...
    def audio_callback(self, recognizer, audio, initial_prompt="This is a Mario voice controller. "
        ...
        try:
            ...
            transcribed_text = self.correct_transcription(result["text"].strip())
...
if __name__ == "__main__":
    controller = VoiceControllerMPS(dataset_path="actual_dataset.csv")
